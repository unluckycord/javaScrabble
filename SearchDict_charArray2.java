public class SearchDict_charArray2 {
    ...
    public static void main(String args[]) {
        ...
        String Dict[] = { "go", "bat", "me", "eat",
                "goal", "boy", "ru", "aye", "what", "bruh", "nah",
                "sum", "sheesh", "human", "taco", "me", "eat",
                "list", "girl", "sheer", "limit", "cheese", "shred",
                "break", "car", "frank", "bank", "blank", "dank",
                "both", "knife", "doofus", "fool", "rule", "drank",
                "none", "sale", };
